describe("In PlayMatching", function() {
  let OK = true;
    ...
    let PLAYER0_WIN_SCORES = [1, 0];
    let PLAYER1_WIN_SCORES = [0, 1];
    let TIE_SCORES = [0, 0];
    let BOARD_NO_MOVES : Board =
    [['R', 'G', 'B', '', 'G', 'B', 'R', 'G'],
     ['Y', 'B', 'R', 'G', '', 'R', 'G', 'Y'],
     ['B', 'R', '', '', 'R', 'G', 'R', 'G'],
     ['Y', 'G', 'Y', 'R', 'Y', '', 'Y', 'G'],
     ...
     if (numberOfTimesCalledRandom == 1) return 1;
     if (numberOfTimesCalledRandom == 2) return 2;
     if (numberOfTimesCalledRandom == 3) return 3;
  ...
  it("Initial state", function() {
    ...
    [['R', 'G', 'B', 'R', 'G', '', '', ''],
       ...
       ['R', 'G', '', 'R', 'G', 'B', '', 'G'],
       ['G', 'B', 'R', 'G', 'B', 'R', 'G', 'R']],
        [0, 0], [{row: 0, col: 5, color: 'R'}, {row: 0, col: 6, color: 'B'},{row: 0, col: 7, color: 'Y'},
        {row: 2, col: 0, color: 'B'}, {row: 3, col: 0, color: 'B'}, {row: 4, col: 0, color: 'G'},
        {row: 3, col: 7, color: 'B'},{row: 4, col: 7, color: 'R'},{row: 5, col: 7, color: 'Y'}], 
      [['R', 'G', 'B', 'R', 'G', 'R', 'B', 'Y'],
       ['G', 'B', 'R', 'G', 'B', 'R', 'G', 'B'],
       ['B', 'R', '', '', '', 'G', 'R', 'G'],
       ['B', 'G', 'B', 'R', 'G', 'B', 'R', 'B'],
  ...
  it("Making a move on a board with < 9 empty spots is illegal", function() {
   ...
   it("placing a piece outside board area is illegal", function() {
    ...
    [['R', 'G', 'B', 'R', 'G', '', '', ''],
       ...
       ['R', 'G', '', 'R', 'G', 'B', '', 'G'],
       ['G', 'B', 'R', 'G', 'B', 'R', 'G', 'R']],
        [0, 0], [{row: 0, col: 8, color: 'R'}, {row: 0, col: 0, color: 'B'},{row: 0, col: 10, color: 'Y'}], 
    [['R', 'G', 'B', 'R', 'G', '', '', ''],
       ['G', 'B', 'R', 'G', 'B', 'R', 'G', 'B'],
       ['', 'R', '', '', '', 'G', 'R', 'G'],
       ['', 'G', 'B', 'R', 'G', 'B', 'R', ''],
